...
function Header() {
  ...
  return (
    <>
      ...
      >
        <div
          className="max-w-7xl  py-3 mx-auto font-medium flex-none md:flex items-center justify-between "
        ...
        >
          ...
          <div>
            <ul className="flex-none md:flex items-center justify-center pt-2">
              <li className="mx-6">
                <Link to="/">HOME</Link>
              </li>
              <li className="mx-6">
